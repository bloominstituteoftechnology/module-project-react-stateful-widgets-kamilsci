...
export default function Programmers() {
  ...
  const [chosenProgrammer, setChosenProgrammer] = useState(null)
...
return programmers.find(pr => pr.id == chosenProgrammer).name
  };

  const style = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: chosenProgrammer ? 'Gold' : 'royalblue', // 🤔 color turns to gold, when celebrating
  };
